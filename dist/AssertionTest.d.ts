...
declare function AssertionTestImpl(this: AssertionTest | null | undefined | void): AssertionTest;
declare namespace AssertionTestImpl {
    var VerifyErrorWasNotThrown: (next: (err: Error | null | undefined, ...res: any[]) => void, ...args: any[]) => void;
    var VerifyErrorWasThrown: (next: (err: Error | null | undefined, ...res: any[]) => void, ...args: any[]) => void;
}
