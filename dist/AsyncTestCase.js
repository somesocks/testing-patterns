...
var InOrder_1 = __importDefault(require("async-patterns/InOrder"));
var CatchError_1 = __importDefault(require("async-patterns/CatchError"));
...
function AsyncTestCaseImpl() {
    var self = this instanceof AsyncTestCaseImpl ?
...
* @memberof testing-patterns.AssertionTest#
*/
AsyncTestCaseImpl.prototype.setup = function setup(_setup) {
    this._setup = _setup;
    return this;
};
/**
...
* @memberof testing-patterns.AssertionTest#
*/
AsyncTestCaseImpl.prototype.prepare = function prepare(_prepare) {
...
* @memberof testing-patterns.AssertionTest#
*/
AsyncTestCaseImpl.prototype.execute = function execute(_execute) {
...
* @memberof testing-patterns.AssertionTest#
*/
AsyncTestCaseImpl.prototype.verify = function verify() {
    var args = [];
...
* @memberof testing-patterns.AssertionTest#
*/
AsyncTestCaseImpl.prototype.build = function build() {
...
*/
AsyncTestCaseImpl.VerifyErrorWasNotThrown = Assert_1.default(function (context) { return context.error == null; }, function (context) {
...
* @memberof testing-patterns.AsyncTestCase
*/
AsyncTestCaseImpl.VerifyErrorWasThrown = Assert_1.default(function (context) { return context.error != null; }, 'AsyncTestCase.VerifyErrorWasThrown: error was not thrown');
module.exports = AsyncTestCaseImpl;
